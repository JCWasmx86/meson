...
class CommandLineParser:
    def __init__(self):
        ...
        from . import mconf, mdist, minit, minstall, mintro, msetup, mtest, rewriter, msubprojects, munstable_coredata, mcompile, mdevenv, mfmt
        ...
        self.add_command('fmt_unstable', mfmt.add_arguments, mfmt.run,
                         help_msg='Format the specified file')
